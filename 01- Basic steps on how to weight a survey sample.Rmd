...
* __alcohol_day__: Grams of alcohol ingested on a daily basis. Computed in the *Recoding* section by weighting the amount of alcohol drank last time during weekdays and weekend.
...
Apart from the variables of interest (cigarette and alcohol consumption) our dataset has other variables obtained from survey responses. Obviously, these are only available for respondents. 
