...
data.nonresponse.model %<>%
  mutate(response = as.numeric(interva) == 1)
...
mod_binomial <- train(response ~ type + access + physa + littera + vandaa,  data=data.nonresponse.model, method="glm", family="binomial",
