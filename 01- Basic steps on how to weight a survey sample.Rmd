...
vars.sample.data <- c("cntry", "idno", "psu", "domain", "stratify", "prob")

vars.paradata <- c("idno", "cntry", "typesamp", "age_su", "gndr_su", "defectcf",
                   "interva", "telnum", "agea_1", "gendera1", "type", "access", 
                   "physa", "littera", "vandaa", "reconva")

resp.id <- c("idno", "cntry")
...
attributes(sample.data)$variable.labels <- selected.labels.sample.data

attributes(paradata)$variable.labels <- selected.labels.paradata

attributes(responses)$variable.labels <- selected.labels.responses


rm(selected.labels.sample.data,
   selected.labels.paradata,
...
We do some recoding for selected variables.
