...
Fortunately for us, the probablity of each respondent of being sampled was included in the ESS dataset. 
...
Their distribution is skewed to the left, with the vast majority of respondents having probability of `r sort(table(data$prob), decreasing = T)[[1]]` or `r sort(table(data$prob), decreasing = T)[[2]]`
