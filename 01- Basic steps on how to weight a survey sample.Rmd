...
These are the 5 classes created using 20th, 40th, 60th and 80th quantiles.
...
After creating the classes, a good practice would be to check for covariate balance. Units in the same class should have similar values in these covariates. At the same time, we would ideally find differencess between classes.
