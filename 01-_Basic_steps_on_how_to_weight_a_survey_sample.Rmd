...
Then we collect the weights from the *'our.raked'* and *'ess.raked'* objects we just computed and we add them to our dataset.
...
Now we can compare our computed final calibrated weights with those computed by the experts in charge of the 7th ESS.  
