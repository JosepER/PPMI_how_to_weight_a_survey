...
rm(data.nonresponse.model, x.matrix, cv.success.glmnet, cv.success.log.reg, folds, formula.,
   glm.cv.model, i, log.reg.m, predicted.lasso, predicted.log, predicted.log.tr, success.rate.glmnet, success.rate.logreg, train.correct.lasso, train.correct.logreg)
...
mygithub.url <- getURL("https://github.com/JosepER/PPMI_how_to_weight_a_survey/blob/master/data/Eurostat/Age%20by%20gender%20.xlsx")

age.gender.eurostat <- download.file(mygithub.url,"myfile", method="curl")
